...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      imageSrc="http://img.b2bpic.net/free-photo/assortment-tamales-ingredients-green-table_23-2148942270.jpg"
  ...
  <div id="trust" data-section="trust">
      ...
      metrics={[
        {
          id: "1",          value: "Fresh",          description: "Hand-tossed pizza dough made daily."},
        {
          id: "2",          value: "100%",          description: "Family-friendly atmosphere always."},
        {
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          id: "f1",          title: "Fresh Ingredients",          description: "Locally sourced toppings and fresh dough.",          media: {
            imageSrc: "http://img.b2bpic.net/free-vector/summer-background-with-watercolor-ice-cream_23-2147638086.jpg"},
          items: [],
          reverse: false,
        },
        {
          id: "f2",          title: "Fun Environment",          description: "The perfect place for birthday parties and after-school snacks.",          media: {
